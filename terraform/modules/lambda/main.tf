...
# Lambda URIs are "{+lambda}/{+function}" e.g. "travelPlanner/ping".
# We also support path matching at the root e.g. "travelPlanner" but these require definining separate "_root" terraform resources.
