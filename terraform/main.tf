...
resource "aws_ecs_cluster" "travelPlanner" {
  name = "travelPlanner"
}

resource "aws_ecr_repository" "travelPlanner" {
  name                 = "travelPlanner"
...
module "webserver" {
  ...
  ecr_repository = aws_ecr_repository.travelPlanner.repository_url
  ecs_cluster    = aws_ecs_cluster.travelPlanner.id
