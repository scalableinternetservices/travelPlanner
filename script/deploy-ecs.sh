...
usage="Usage: deploy-ecs.sh [travelPlanner-app-web|travelPlanner-app-background] [sha]"
...
new_image="101624687637.dkr.ecr.us-west-2.amazonaws.com/travelPlanner:$2"
...
aws ecs update-service --cluster travelPlanner \
  --no-cli-pager \
  --region "$ecs_region" \
